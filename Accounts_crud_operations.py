...
def main():
    ...
    try:
        bank.create_account("3001", "Mathieu", 50000)
        bank.create_account("3002", "Pierre", 6500)
    except ValueError as e:
        print(e)

    # Read an account
    try:
        account = bank.read_account("3001")
    ...
    # Update an account
    try:
        bank.update_account("3001", new_account_holder="Mathieu", new_balance=2000)
    except ValueError as e:
        print(e)

    # Delete an account
    try:
        bank.delete_account("3002")
    except ValueError as e:
        print(e)

    # Attempt to read a deleted account
    try:
        bank.read_account("3002")
    except ValueError as e:
        print(e)
